            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "fmt": {"type": "string", "description": "wttr.in format, default '3' for brief"},
                        "date": {"type": "string", "description": "Forecast date (YYYY-MM-DD or MM-DD)"},
                        "lang": {"type": "string", "description": "Language code, default 'zh'"},
                        "raw_json": {"type": "boolean", "description": "Include raw wttr.in JSON when using date"},
                    },
                    "required": ["city"],
                },
            },
