...
from tools_history import append_log_entries, format_tool_result, read_log_text, tool_specs
...
def should_route_for_tools(text: str) -> bool:
    keywords = ("历史", "回顾", "查找", "搜索", "名字", "姓名", "叫啥", "我是谁", "身份")
        ...
        try:
            ...
            if tool_calls:
                for call in tool_calls:
                    ...
                    tool_result = search_history_with_llm(base_url, api_key, model, log_text, query)
                    print("检索结果:")
